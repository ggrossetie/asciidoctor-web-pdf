...
== Kogito
// tag::update_3_9[]
Quarkus integrates with http://www.kiegroup.org/[Kogito], a next generation business automation toolkit from Drools and jBPM projects for adding businesss automation capabilities.

To start using it you only need to add next extension:
