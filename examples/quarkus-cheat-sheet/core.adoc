...
You can implement your own conversion types from String to custom type.
You need to implement `org.eclipse.microprofile.config.spi.Converter` interface:
