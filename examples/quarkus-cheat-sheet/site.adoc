...
[%collapsible]
====
include::quarkus-cheat-sheet.adoc[tag=update_1_6]
====

.Flyway
[%collapsible]
====
include::quarkus-cheat-sheet.adoc[tag=update_1_7]
====

.Reactive PostgreSQL Client
[%collapsible]
====
include::quarkus-cheat-sheet.adoc[tag=update_1_8]
====

.Keycloak
[%collapsible]
====
include::quarkus-cheat-sheet.adoc[tag=update_1_9]
====
